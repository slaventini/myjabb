...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, server, port);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password, String server, String port) {
            mEmail = email;
            mPassword = password;
            mServer = server;
            mPort = port;
        ...
        protected Boolean doInBackground(Void... params) {
            return getApp().login(mEmail, mPassword, mServer, mPort);
        }
